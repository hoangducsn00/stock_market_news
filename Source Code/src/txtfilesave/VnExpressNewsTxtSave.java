...
public class VnExpressNewsTxtSave extends ATxtFileSave implements ITxtFileSave {
	private final static String FILE_URL_VNEXPRESS = (getFolderUrl() + "VnExpress.txt");

	public VnExpressNewsTxtSave() {
	...
	public void storage(String dataStorage) {
		try {
			File file = new File(FILE_URL_VNEXPRESS);

...
public class HOSENewsTxtSave extends ATxtFileSave implements ITxtFileSave {
	private final static String FILE_URL_HOSE = (getFolderUrl() + "HOSE.txt");

	public HOSENewsTxtSave() {
	...
	public void storage(String dataStorage) {
		try {
			File file = new File(FILE_URL_HOSE);
